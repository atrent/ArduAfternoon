...
const unsigned int TERMWIDTH = 80 ;
const unsigned int TERMHEIGHT = 25 ;
...
Serial.println("***************");
plot(0,maxScreenRange());
delay(100);
plot(45,maxScreenRange());
delay(100);
plot(60,maxScreenRange());
delay(100);
plot(90,maxScreenRange());
delay(100);
plot(120,maxScreenRange());
delay(100);
plot(180,maxScreenRange());
delay(100);
...
void plot(int angolo, int distanza) {
  ...
  plotNormale(angolo,distanza);
}


void plotNormale(int angolo, int distanza) {
    Serial.write(27);
    Serial.write('[');
